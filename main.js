...
function draw() {
    ...
    if ("Your_Sketch" == sketch) {
        document.getElementById("Your_Sketch").innerHTML = "set";
...
function check_sketch() {
    timer = document.getElementById("Timer").innerHTML = timer + 1;
